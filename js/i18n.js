...
(function () {
  ...
  const STRINGS = {
    ...
    join_no_server: { gu: 'મૅચમેકિંગ સર્વર સુધી પહોંચી શકાયું નહીં — ઇન્ટરનેટ તપાસો', en: "Couldn't reach the matchmaking server — check your internet" },
    join_no_host: { gu: 'હોસ્ટ સાથે સીધું જોડાણ ન થયું — તમારું Wi‑Fi ડિવાઇસ‑ટુ‑ડિવાઇસ જોડાણ બ્લૉક કરતું હોઈ શકે. મોબાઇલ ડેટા/હૉટસ્પૉટ અજમાવો.', en: "Couldn't connect to the host — your Wi‑Fi may block device‑to‑device links. Try mobile data / a hotspot." },
    or_label: { gu: 'અથવા', en: 'or' },
    tip_label: { gu: 'ટિપ', en: 'Tip' },
    hotspot_tip: { gu: 'એક જ Wi‑Fi પર છો છતાં જોડાણ નથી થતું? એક ફોનનું હૉટસ્પૉટ ચાલુ કરો અને બધા એ હૉટસ્પૉટમાં જોડાઓ — પછી રમત હોસ્ટ/જૉઇન કરો.', en: "Same Wi‑Fi but can't connect? Turn on one phone's hotspot and have everyone join that hotspot — then host/join the game." },
