/*! PeerJS v1.5.5 — WebRTC peer-to-peer data/media, bundled UMD build.
 *  Vendored (no build step) from https://registry.npmjs.org/peerjs/-/peerjs-1.5.5.tgz (dist/peerjs.min.js).
 *  License: MIT (c) 2015 Michelle Bu, Eric Zhang and PeerJS contributors — https://github.com/peers/peerjs
 *  Exposes window.Peer. Used only by js/net.js for the multiplayer "Host a game" mode.
 */
