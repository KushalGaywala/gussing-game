/*! jsQR v1.4.0 — pure-JS QR code decoder (image data -> string), zero deps. Minified.
 *  Vendored from https://registry.npmjs.org/jsqr/-/jsqr-1.4.0.tgz (dist/jsQR.js), minified with terser.
 *  License: Apache-2.0 (c) Cosmo Wolfe — https://github.com/cozmo/jsQR
 *  Exposes global `jsQR(imageData, width, height)`. Lazy-loaded by js/app.js as the QR-scanner
 *  fallback for browsers without the native BarcodeDetector API (e.g. iOS Safari, Firefox).
 */
